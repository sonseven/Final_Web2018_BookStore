...
Class Product extends MY_Controller
{
    ...
    */
    function search(){
        ...
        $this->data['key'] = trim($key); //xoa khoang trong
        $input = array();
    ...
    */
    ...
    function raty(){
        ...
        //lay thong tin
        $id = $this->input->post('id'); //lay id san pham gui len tu ajax
        ...
        $result = array();
        //neu da ton tai id san pham nay trong session danh gia
        if(isset($raty[$id])){
            $result['msg'] = 'Ban chi duoc danh gia 1 lan cho san pham nay';
            $output        = json_encode($result); //tra ve ma json
            echo $output;
            exit();
        }
        ...
        //cap nhat lai danh gia cho san pham
        $this->product_model->update($id, $data);

        //khai bao du lieu tra ve
        $result['complete'] = TRUE;
        $result['msg'] = 'Cam on ban da danh gia cho san pham nay';
        $output = json_encode($result); //tra ve ma json
        echo $output;
        exit();
    }
