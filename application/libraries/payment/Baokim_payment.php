<?php
	...
	class BaoKim_payment{
		...
		var $code 		= 'baokim';
		var $setting 	= array(
			'business' 				=> 'sonsevenpro@gmail.com',//tai khoan cua nguoi nhan tien
			'merchant_id' 			=> '34476',//id cua website khi dang ky ben baokim
			'secure_pass' 			=> 'd98ef84c79f58530',//mat khau giao tiep
			'cost_constant'			=> 1700 ,
			'cost_percent'			=> 1,
		);
		...
		//var $url 		= 'http://sandbox.baokim.vn/payment/order';	// URL chay test
		var $ip			= array('ns27.domaincontrol.com','210.245.80.14', '210.245.83.89', '210.245.83.94', '42.112.21.10',
			'210.245.83.90', '210.245.80.104', '210.245.88.180', '210.245.83.82', '210.245.83.87','127.0.0.1'
